...
class Site(models.Model):
    ...
    def save(self, *args, **kwargs):
        # Calling full_clean in save ensures that the slug will be autogenerated
        # and validated no matter what route the data took to get into the
        # database. https://code.djangoproject.com/ticket/13100
        self.full_clean()
